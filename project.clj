(defproject cljsjs-interop-workshop "0.1.0-SNAPSHOT"
  ...
  :dependencies [[org.clojure/clojure "1.8.0"]
                 ...
                 ;; no need to cljsjs/chance dependency
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                ;; into your build
                :figwheel {:on-jsload "cljsjs-interop-workshop.core/on-js-reload"
                ...
                :compiler {:main cljsjs-interop-workshop.core
                           ...
                           :output-to "resources/public/js/compiled/cljsjs_interop_workshop.js"
